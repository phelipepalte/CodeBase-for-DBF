...
Public Module CodeBase
    ...
    '===================================================================================
#If USE_D4DLL Then
    Declare Sub c4setAcceptTimeOut Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer)
    Declare Function code4actionCode Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4accessMode Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Sub code4autoIncrementStart Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Double)
    Declare Function code4autoOpen Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4calcCreate Lib "c465net.dll" (ByVal c4 As Integer, ByVal expr4 As Integer, ByVal fcnName As String) As Short
    Declare Sub code4calcReset Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function code4codePage Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4collatingSequence Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4collate Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4compatibility Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4compress Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4connect Lib "c465net.dll" (ByVal c4 As Integer, ByVal serverId As String, ByVal processId As String, ByVal userName As String, ByVal password As String, ByVal protocol As String) As Short
    Declare Function code4close Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4createTemp Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4data Lib "c465net.dll" (ByVal c4 As Integer, ByVal AliasName As String) As Integer
    Declare Function code4dateFormatVB Lib "c465net.dll" Alias "code4dateFormat" (ByVal c4 As Integer) As Integer
    Declare Function code4dateFormatSet Lib "c465net.dll" (ByVal c4 As Integer, ByVal fmt As String) As Short
    Declare Function code4errCreate Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errDefaultUnique Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errorCode Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errExpr Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errFieldName Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errGo Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errSkip Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errTagName Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Sub code4exit Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function code4fileFlush Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4flush Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4hInst Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4indexBlockSize Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4indexBlockSizeSet Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4indexExtensionVB Lib "c465net.dll" Alias "code4indexExtension" (ByVal c4 As Integer) As Integer
    Declare Function code4hWnd Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4allocDll Lib "c465net.dll" (ByVal dllName As String) As Integer
    Declare Function code4initUndo Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Sub code4largeOn Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function code4lock Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4lockAttempts Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4lockAttemptsSingle Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Sub code4lockClear Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function code4lockDelay Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4lockEnforce Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4lockFileNameVB Lib "c465net.dll" Alias "code4lockFileName" (ByVal c4 As Integer) As Integer
    Declare Function code4lockItem Lib "c465net.dll" (ByVal c4 As Integer) As Integer
    Declare Function code4lockNetworkIdVB Lib "c465net.dll" Alias "code4lockNetworkId" (ByVal c4 As Integer) As Integer
    Declare Function code4lockUserIdVB Lib "c465net.dll" Alias "code4lockUserId" (ByVal c4 As Integer) As Integer
    Declare Function code4log Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4logCreate Lib "c465net.dll" (ByVal c4 As Integer, ByVal logName As String, ByVal userId As String) As Short
    Declare Function code4logFileNameVB Lib "c465net.dll" (ByVal c4 As Integer) As Integer
    Declare Function code4logOpen Lib "c465net.dll" (ByVal c4 As Integer, ByVal logName As String, ByVal userId As String) As Short
    Declare Sub code4logOpenOff Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function code4memExpandBlock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memExpandData Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memExpandIndex Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memExpandLock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memExpandTag Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memSizeBlock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memSizeBuffer Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memSizeMemo Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memSizeMemoExpr Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memSizeSortBuffer Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memSizeSortPool Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memStartBlock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memStartData Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memStartIndex Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memStartLock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4memStartMax Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer) As Integer
    Declare Function code4memStartTag Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errOff Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errOpen Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4optAll Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4optimize Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4optStart Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4optSuspend Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4optimizeWrite Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4readLock Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4readOnly Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4errRelate Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4safety Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4singleOpen Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Function code4serverOS Lib "c465net.dll" (ByVal c4 As Integer) As Integer
    Declare Function code4timeout Lib "c465net.dll" (ByVal c4 As Integer) As Integer
    Declare Sub code4timeoutSet Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Integer)
    Declare Function code4tranStart Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4tranStatus Lib "c465net.dll" Alias "code4tranStatusCB" (ByVal c4 As Integer) As Short
    Declare Function code4tranCommit Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4tranRollback Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4unlock Lib "c465net.dll" (ByVal c4 As Integer) As Short
    Declare Function code4unlockAuto Lib "c465net.dll" Alias "code4unlockAutoCB" (ByVal c4 As Integer) As Short
    Declare Function code4useGeneralTagsInRelate Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As Short) As Short
    Declare Sub code4unlockAutoSet Lib "c465net.dll" Alias "code4unlockAutoSetCB" (ByVal c4 As Integer, ByVal value As Short)
    Declare Sub code4verifySet Lib "c465net.dll" (ByVal c4 As Integer, ByVal value As String)
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function d4aliasCB Lib "c465net.dll"  Alias "d4alias"(ByVal d4 As Integer) As Integer
    Declare Sub d4aliasSet Lib "c465net.dll" (ByVal d4 As Integer, ByVal AliasValue As String)
    Declare Function d4append Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4appendBlank Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4appendStart Lib "c465net.dll" (ByVal d4 As Integer, ByVal UseMemoEntries As Short) As Short
    Declare Sub d4blank Lib "c465net.dll" (ByVal d4 As Integer)
    Declare Function d4bof Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4bottom Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4changed Lib "c465net.dll" (ByVal d4 As Integer, ByVal intFlag As Short) As Short
    Declare Function d4check Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4close Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4codePage Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4createCB Lib "c465net.dll"  Alias "d4create"(ByVal c4 As Integer, ByVal DbfName As String, ByVal fieldinfo As Integer, ByVal tagInfo As Integer) As Integer
    Declare Function d4createLow Lib "c465net.dll" Alias "d4create" (ByVal c4 As Integer, ByVal DbfName As String, ByRef fieldinfo As FIELD4INFOCB, ByRef tagInfo As TAG4INFOCB) As Integer
    Declare Function d4createLow Lib "c465net.dll" Alias "d4create" (ByVal c4 As Integer, ByVal DbfName As String, ByRef fieldinfo As FIELD4INFOCB, Optional ByVal tagInfo As Integer = 0) As Integer
    Declare Sub d4delete Lib "c465net.dll" (ByVal d4 As Integer)
    Declare Function d4deleted Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4eof Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4field Lib "c465net.dll" (ByVal d4 As Integer, ByVal FieldName As String) As Integer
    Declare Function d4fieldInfo Lib "c465net.dll" (ByVal d4 As Integer) As Integer
    Declare Function d4fieldJ Lib "c465net.dll" (ByVal d4 As Integer, ByVal JField As Short) As Integer
    Declare Function d4fieldNumber Lib "c465net.dll" (ByVal d4 As Integer, ByVal FieldName As String) As Short
    Declare Function d4fieldsAddCB Lib "c465net.dll" Alias "d4fieldsAdd" (ByVal d4 As Integer, ByVal nFields As Short, ByRef fieldinfo As FIELD4INFOCB) As Integer
    Declare Function d4fieldsRemoveCB Lib "c465net.dll" Alias "d4fieldsRemove" (ByRef d4 As Integer, ByVal nFields As Short, ByRef fieldNames As Integer) As Integer
    Declare Function d4fileNameCB Lib "c465net.dll"  Alias "d4fileName"(ByVal d4 As Integer) As Integer
    Declare Function d4flush Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4freeBlocks Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4goLow Lib "c465net.dll" (ByVal d4 As Integer, ByVal RecNum As Integer, ByVal goForWrite As Short) As Short
    Declare Function d4goBof Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4goEof Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4index Lib "c465net.dll" (ByVal d4 As Integer, ByVal IndexName As String) As Integer
    Declare Function d4log Lib "c465net.dll"  Alias "d4logVB"(ByVal d4 As Integer, ByVal logging As Short) As Short
    Declare Function d4lock Lib "c465net.dll"  Alias "d4lockVB"(ByVal d4 As Integer, ByVal recordNum As Integer) As Short
    Declare Function d4lockAdd Lib "c465net.dll" (ByVal d4 As Integer, ByVal recordNum As Integer) As Short
    Declare Function d4lockAddAll Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4lockAddAppend Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4lockAddFile Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4lockAll Lib "c465net.dll"  Alias "d4lockAllVB"(ByVal d4 As Integer) As Short
    Declare Function d4lockAppend Lib "c465net.dll"  Alias "d4lockAppendVB"(ByVal d4 As Integer) As Short
    Declare Function d4lockFile Lib "c465net.dll"  Alias "d4lockFileVB"(ByVal d4 As Integer) As Short
    Declare Function d4logStatus Lib "c465net.dll"  Alias "d4logStatusCB"(ByVal d4 As Integer) As Short
    Declare Function d4memoCompress Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4numFields Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4open Lib "c465net.dll" (ByVal c4 As Integer, ByVal DbfName As String) As Integer
    Declare Function d4openClone Lib "c465net.dll" (ByVal d4 As Integer) As Integer
    Declare Function d4optimize Lib "c465net.dll"  Alias "d4optimizeVB"(ByVal d4 As Integer, ByVal OptFlag As Short) As Short
    Declare Function d4optimizeWrite Lib "c465net.dll"  Alias "d4optimizeWriteVB"(ByVal d4 As Integer, ByVal OptFlag As Short) As Short
    Declare Function d4pack Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4packData Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4position Lib "c465net.dll" (ByVal d4 As Integer) As Double
    Declare Function d4positionSet Lib "c465net.dll" (ByVal d4 As Integer, ByVal Percentage As Double) As Short
    Declare Function d4readBuffer Lib "c465net.dll" (ByVal d4 As Integer, ByVal numRecsToBuf As Integer, ByVal doMemos As Short) As Integer
    Declare Sub d4recall Lib "c465net.dll" (ByVal d4 As Integer)
    Declare Function d4recCount Lib "c465net.dll"  Alias "d4recCountDo"(ByVal d4 As Integer) As Integer
    Declare Function d4recNo Lib "c465net.dll"  Alias "d4recNoLow"(ByVal d4 As Integer) As Integer
    Declare Function d4record Lib "c465net.dll"  Alias "d4recordLow"(ByVal d4 As Integer) As Integer
    Declare Function d4recWidth Lib "c465net.dll"  Alias "d4recWidth_v"(ByVal d4 As Integer) As Integer
    Declare Function d4remove Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4refresh Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4refreshRecord Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4reindex Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Delegate Function d4reindexWithProgressDelegate(ByVal percent As Double) As Short
    Declare Function d4reindexWithProgress Lib "c465net.dll" (ByVal d4 As Integer, ByVal callback As d4reindexWithProgressDelegate, ByVal milliseconds As Integer) As Short
    Declare Function d4seek Lib "c465net.dll" (ByVal d4 As Integer, ByVal seekValue As String) As Short
    Declare Function d4seekDouble Lib "c465net.dll" (ByVal d4 As Integer, ByVal value As Double) As Short
    Declare Function d4seekN Lib "c465net.dll" (ByVal d4 As Integer, ByVal seekValue As String, ByVal seekLen As Short) As Short
    Declare Function d4seekNext Lib "c465net.dll" (ByVal d4 As Integer, ByVal seekValue As String) As Short
    Declare Function d4seekNextDouble Lib "c465net.dll" (ByVal d4 As Integer, ByVal seekValue As Double) As Short
    Declare Function d4seekNextN Lib "c465net.dll" (ByVal d4 As Integer, ByVal seekValue As String, ByVal seekLen As Short) As Short
    Declare Function d4skip Lib "c465net.dll" (ByVal d4 As Integer, ByVal NumberRecords As Integer) As Short
    Declare Function d4tag Lib "c465net.dll" (ByVal d4 As Integer, ByVal TagName As String) As Integer
    Declare Function d4tagDefault Lib "c465net.dll" (ByVal d4 As Integer) As Integer
    Declare Function d4tagNext Lib "c465net.dll" (ByVal d4 As Integer, ByVal TagOn As Integer) As Integer
    Declare Function d4tagPrev Lib "c465net.dll" (ByVal d4 As Integer, ByVal TagOn As Integer) As Integer
    Declare Sub d4tagSelect Lib "c465net.dll" (ByVal d4 As Integer, ByVal tPtr As Integer)
    Declare Function d4tagSelected Lib "c465net.dll" (ByVal d4 As Integer) As Integer
    Declare Function d4tagSync Lib "c465net.dll" (ByVal d4 As Integer, ByVal tPtr As Integer) As Short
    Declare Function d4top Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4unlock Lib "c465net.dll" (ByVal d4 As Integer) As Short
    Declare Function d4unlockFiles Lib "c465net.dll"  Alias "code4unlock"(ByVal d4 As Integer) As Short
    Declare Function d4write Lib "c465net.dll"  Alias "d4writeVB"(ByVal d4 As Integer, ByVal RecNum As Integer) As Short
    Declare Function d4writeBuffer Lib "c465net.dll" (ByVal r4 As Integer, ByVal numRecs As Integer) As Integer
    Declare Function d4zap Lib "c465net.dll" (ByVal d4 As Integer, ByVal StartRecord As Integer, ByVal EndRecord As Integer) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Sub date4assignLow Lib "c465net.dll" (ByVal dateForm As String, ByVal julianDay As Integer, ByVal isOle As Short)
    Declare Function date4cdowCB Lib "c465net.dll"  Alias "date4cdow"(ByVal dateForm As String) As Integer
    Declare Function date4cmonthCB Lib "c465net.dll"  Alias "date4cmonth"(ByVal dateForm As String) As Integer
    Declare Function date4day Lib "c465net.dll"  Alias "date4day_v"(ByVal dateForm As String) As Short
    Declare Function date4dow Lib "c465net.dll" (ByVal dateForm As String) As Short
    Declare Sub date4formatCB Lib "c465net.dll"  Alias "date4format"(ByVal dateForm As String, ByVal Result As String, ByVal pic As String)
    Declare Sub date4initCB Lib "c465net.dll"  Alias "date4init"(ByVal dateForm As String, ByVal value As String, ByVal pic As String)
    Declare Function date4isLeap Lib "c465net.dll" (ByVal dateForm As String) As Short
    Declare Function date4long Lib "c465net.dll" (ByVal dateForm As String) As Integer
    Declare Function date4month Lib "c465net.dll"  Alias "date4month_v"(ByVal dateForm As String) As Short
    Declare Sub date4timeNow Lib "c465net.dll" (ByVal TimeForm As String)
    Declare Sub date4todayCB Lib "c465net.dll"  Alias "date4today"(ByVal dateForm As String)
    Declare Function date4year Lib "c465net.dll"  Alias "date4year_v"(ByVal dateForm As String) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function error4 Lib "c465net.dll"  Alias "error4VB"(ByVal c4 As Integer, ByVal errCode As Short, ByVal extraInfo As Integer) As Short
    Declare Sub error4exitTest Lib "c465net.dll" (ByVal c4 As Integer)
    Declare Function error4describe Lib "c465net.dll"  Alias "error4describeVB"(ByVal c4 As Integer, ByVal errCode As Short, ByVal extraInfo As Integer, ByVal desc1 As String, ByVal desc2 As String, ByVal desc3 As String) As Short
    Declare Function error4file Lib "c465net.dll" (ByVal c4 As Integer, ByVal fileName As String, ByVal overwrite As Short) As Short
    Declare Function error4lastDescription Lib "c465net.dll" (ByVal c4 As Integer) As String
    Declare Function error4set Lib "c465net.dll" (ByVal c4 As Integer, ByVal errCode As Short) As Short
    Declare Function error4textCB Lib "c465net.dll"  Alias "error4text"(ByVal c4 As Integer, ByVal errCode As Integer) As Integer
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function expr4data Lib "c465net.dll"  Alias "expr4dataCB"(ByVal exprPtr As Integer) As Integer
    Declare Function expr4double Lib "c465net.dll" (ByVal exprPtr As Integer) As Double
    Declare Sub expr4free Lib "c465net.dll"  Alias "expr4freeCB"(ByVal exprPtr As Integer)
    Declare Function expr4len Lib "c465net.dll"  Alias "expr4lenCB"(ByVal exprPtr As Integer) As Integer
    Declare Function expr4nullLow Lib "c465net.dll" (ByVal exprPtr As Integer, ByVal forAdd As Short) As Short
    Declare Function expr4parse Lib "c465net.dll"  Alias "expr4parseCB"(ByVal d4 As Integer, ByVal expression As String) As Integer
    Declare Function expr4sourceCB Lib "c465net.dll"  Alias "expr4source"(ByVal exprPtr As Integer) As Integer
    Declare Function expr4strCB Lib "c465net.dll"  Alias "expr4str"(ByVal exprPtr As Integer) As Integer
    Declare Function expr4true Lib "c465net.dll" (ByVal exprPtr As Integer) As Short
    Declare Function expr4typeCB Lib "c465net.dll" (ByVal exprPtr As Integer) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Sub f4assignBinaryVB Lib "c465net.dll"  Alias "f4assignN"(ByVal fPtr As Integer, ByRef value As Byte, ByVal length As Short)
    Declare Sub f4assignChar Lib "c465net.dll"  Alias "f4assignCharVB"(ByVal fPtr As Integer, ByVal Char_Renamed As Short)
    Declare Sub f4assignCurrency Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As String)
    Declare Sub f4assignDateTime Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As String)
    Declare Sub f4assignDouble Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As Double)
    Declare Sub f4assignField Lib "c465net.dll" (ByVal fPtrTo As Integer, ByVal fPtrFrom As Integer)
    Declare Sub f4assignIntVB Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As Short)
    Declare Sub f4assignLong Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As Integer)
    Declare Sub f4assignN Lib "c465net.dll"  Alias "f4assignNVB"(ByVal fPtr As Integer, ByVal value As String, ByVal length As Short)
    Declare Sub f4assignNull Lib "c465net.dll" (ByVal fPtr As Integer)
    Declare Sub f4assignUnicodeVB Lib "c465net.dll" Alias "f4assignUnicode" (ByVal fPtr As Integer, ByRef value As Byte)
    Declare Sub f4blank Lib "c465net.dll" (ByVal fPtr As Integer)
    Declare Function f4char Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4currencyCB Lib "c465net.dll"  Alias "f4currency"(ByVal fPtr As Integer, ByVal numDec As Short) As Integer
    Declare Function f4data Lib "c465net.dll" (ByVal fPtr As Integer) As Integer
    Declare Function f4dateTimeCB Lib "c465net.dll"  Alias "f4dateTime"(ByVal fPtr As Integer) As Integer
    Declare Function f4decimals Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4double Lib "c465net.dll" (ByVal fPtr As Integer) As Double
    Declare Function f4int Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4len Lib "c465net.dll"  Alias "f4len_v"(ByVal fPtr As Integer) As Short
    Declare Function f4long Lib "c465net.dll" (ByVal fPtr As Integer) As Integer
    Declare Function f4memoAssign Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As String) As Short
    Declare Function f4memoAssignBinaryVB Lib "c465net.dll" Alias "f4memoAssignNVB" (ByVal fPtr As Integer, ByRef value As Byte, ByVal length As Short) As Short
    Declare Function f4memoAssignN Lib "c465net.dll" (ByVal fPtr As Integer, ByVal value As String, ByVal length As Integer) As Short
    Declare Sub f4memoAssignUnicodeVB Lib "c465net.dll" Alias "f4memoAssignUnicode" (ByVal fPtr As Integer, ByRef value As String)
    Declare Sub f4memoFree Lib "c465net.dll" (ByVal fPtr As Integer)
    Declare Function f4memoLen Lib "c465net.dll" (ByVal fPtr As Integer) As Integer
    Declare Function f4memoNcpy Lib "c465net.dll" (ByVal fPtr As Integer, ByVal memPtr As String, ByVal memLen As Short) As Short
    Declare Function f4memoNcpyBinary Lib "c465net.dll" Alias "f4memoNcpy" (ByVal fPtr As Integer, ByRef memPtr As Byte, ByVal memLen As Short) As Short
    Declare Function f4memoPtr Lib "c465net.dll" (ByVal fPtr As Integer) As Integer
    Declare Function f4nameCB Lib "c465net.dll"  Alias "f4name"(ByVal fPtr As Integer) As Integer
    Declare Function f4ncpyBinary Lib "c465net.dll" Alias "f4ncpy" (ByVal fPtr As Integer, ByRef memPtr As Byte, ByVal memLength As Short) As Short
    Declare Function f4ncpyCB Lib "c465net.dll"  Alias "f4ncpy"(ByVal fPtr As Integer, ByVal memPtr As String, ByVal memLength As Short) As Short
    Declare Function f4number Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4null Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4ptr Lib "c465net.dll" (ByVal fPtr As Integer) As Integer
    Declare Function f4strCB Lib "c465net.dll"  Alias "f4str"(ByVal fPtr As Integer) As Integer
    Declare Function f4true Lib "c465net.dll" (ByVal fPtr As Integer) As Short
    Declare Function f4type Lib "c465net.dll" (ByVal fPtr As Integer) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function i4close Lib "c465net.dll" (ByVal i4 As Integer) As Short
    Declare Function i4createCB Lib "c465net.dll"  Alias "i4create"(ByVal d4 As Integer, ByVal fileName As String, ByRef tagInfo As TAG4INFOCB) As Integer
    Declare Function i4fileNameCB Lib "c465net.dll"  Alias "i4fileName"(ByVal i4 As Integer) As Integer
    Declare Function i4openCB Lib "c465net.dll" Alias "i4open" (ByVal d4 As Integer, ByVal fileName As String) As Integer
    Declare Function i4reindex Lib "c465net.dll" (ByVal i4 As Integer) As Short
    Declare Function i4tag Lib "c465net.dll" (ByVal i4 As Integer, ByVal fileName As String) As Integer
    Declare Function i4tagInfo Lib "c465net.dll" (ByVal i4 As Integer) As Integer
    Declare Function i4tagAddCB Lib "c465net.dll"  Alias "i4tagAdd"(ByVal i4 As Integer, ByRef tagInfo As TAG4INFOCB) As Short
    Declare Function i4tagRemove Lib "c465net.dll" (ByVal t4 As Integer) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function relate4bottom Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Sub relate4changed Lib "c465net.dll" (ByVal r4 As Integer)
    Declare Function relate4createSlave Lib "c465net.dll" (ByVal r4 As Integer, ByVal d4 As Integer, ByVal mExpr As String, ByVal t4 As Integer) As Integer
    Declare Function relate4count Lib "c465net.dll" (ByVal r4 As Integer) As Integer
    Declare Function relate4data Lib "c465net.dll"  Alias "relate4dataCB"(ByVal r4 As Integer) As Integer
    Declare Function relate4dataTag Lib "c465net.dll"  Alias "relate4dataTagCB"(ByVal r4 As Integer) As Integer
    Declare Function relate4doAll Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4doOne Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4eof Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4errorAction Lib "c465net.dll"  Alias "relate4errorActionVB"(ByVal r4 As Integer, ByVal ErrAction As Short) As Short
    Declare Function relate4free Lib "c465net.dll"  Alias "relate4freeVB"(ByVal r4 As Integer, ByVal CloseFlag As Short) As Short
    Declare Function relate4init Lib "c465net.dll" (ByVal d4 As Integer) As Integer
    Declare Function relate4lockAdd Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4master Lib "c465net.dll"  Alias "relate4masterCB"(ByVal r4 As Integer) As Integer
    Declare Function relate4masterExprCB Lib "c465net.dll" (ByVal r4 As Integer) As Integer
    Declare Function relate4matchLen Lib "c465net.dll"  Alias "relate4matchLenVB"(ByVal r4 As Integer, ByVal length As Short) As Short
    Declare Function relate4next Lib "c465net.dll" (ByRef r4 As Integer) As Short
    Declare Function relate4optimizeable Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4querySet Lib "c465net.dll" (ByVal r4 As Integer, ByVal expr As String) As Short
    Declare Function relate4readBuffer Lib "c465net.dll" (ByVal r4 As Integer, ByVal numRecsToBuf As Integer, ByVal doMemos As Short) As Integer
    Declare Function relate4retain Lib "c465net.dll" (ByVal r4 As Integer, ByVal value As Short) As Short
    Declare Function relate4retrieve Lib "c465net.dll" (ByVal c4 As Integer, ByVal fileName As String, ByVal openFiles As Short, ByVal dataPathName As String) As Integer
    Declare Function relate4save Lib "c465net.dll" (ByVal rel4 As Integer, ByVal fileName As String, ByVal savePathNames As Short) As Short
    Declare Function relate4skip Lib "c465net.dll" (ByVal r4 As Integer, ByVal NumRecs As Integer) As Short
    Declare Function relate4skipEnable Lib "c465net.dll" Alias "relate4skipEnableVB" (ByVal r4 As Integer, ByVal DoEnable As Short) As Short
    Declare Function relate4skipMaster Lib "c465net.dll" (ByVal r4 As Integer, ByVal numSkip As Integer) As Short
    Declare Function relate4sortSet Lib "c465net.dll" (ByVal r4 As Integer, ByVal expr As String) As Short
    Declare Function relate4top Lib "c465net.dll" (ByVal r4 As Integer) As Short
    Declare Function relate4topMaster Lib "c465net.dll" (ByVal r4 As Integer) As Integer
    Declare Function relate4type Lib "c465net.dll" Alias "relate4typeVB" (ByVal r4 As Integer, ByVal rType As Short) As Short
#Else
...
#End If
    ...
    '================================================================================================
#If USE_D4DLL Then
    Declare Function report4caption Lib "c465net.dll" (ByVal r4 As Integer, ByVal caption As String) As Short
    Declare Function report4currency Lib "c465net.dll" (ByVal r4 As Integer, ByVal currncy As String) As Short
    Declare Function report4dateFormat Lib "c465net.dll" (ByVal r4 As Integer, ByVal dateFmt As String) As Short
    Declare Function report4decimal Lib "c465net.dll"  Alias "report4decimal_v"(ByVal r4 As Integer, ByVal decChar As String) As Short
    Declare Function report4do Lib "c465net.dll"  Alias "report4doCB"(ByVal r4 As Integer) As Short
    Declare Sub report4freeLow Lib "c465net.dll" (ByVal r4 As Integer, ByVal freeRelate As Short, ByVal closeFiles As Short, ByVal doPrinterFree As Short)
    Declare Function report4margins Lib "c465net.dll" (ByVal r4 As Integer, ByVal mLeft As Integer, ByVal mRight As Integer, ByVal mTop As Integer, ByVal mBottom As Integer, ByVal uType As Short) As Short
    Declare Function report4pageSize Lib "c465net.dll" (ByVal r4 As Integer, ByVal pHeight As Integer, ByVal pWidth As Integer, ByVal uType As Short) As Short
    Declare Function report4parent32 Lib "c465net.dll" Alias "report4parent" (ByVal r4 As Integer, ByVal hWnd As IntPtr) As Short
    Declare Sub report4printerSelect Lib "c465net.dll" (ByVal r4 As Integer)
    Declare Function report4querySet Lib "c465net.dll" (ByVal r4 As Integer, ByVal queryExpr As String) As Short
    Declare Function report4relate Lib "c465net.dll" (ByVal r4 As Integer) As Integer
    Declare Function report4retrieve Lib "c465net.dll" (ByVal c4 As Integer, ByVal fileName As String, ByVal openFiles As Short, ByVal dataPath As String) As Integer
    Declare Function report4save Lib "c465net.dll" (ByVal r4 As Integer, ByVal fileName As String, ByVal savePaths As Short) As Short
    Declare Function report4screenBreaks Lib "c465net.dll" (ByVal r4 As Integer, ByVal value As Short) As Short
    Declare Function report4separator Lib "c465net.dll"  Alias "report4separator_v"(ByVal r4 As Integer, ByVal separator As String) As Short
    Declare Function report4sortSet Lib "c465net.dll" (ByVal r4 As Integer, ByVal sortExpr As String) As Short
    Declare Function report4toScreen Lib "c465net.dll" (ByVal r4 As Integer, ByVal toScreen As Short) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function t4aliasCB Lib "c465net.dll"  Alias "t4alias"(ByVal t4 As Integer) As Integer
    Declare Function t4close Lib "c465net.dll" (ByVal t4 As Integer) As Short
    Declare Function t4descending Lib "c465net.dll"  Alias "tfile4isDescending"(ByVal t4 As Integer) As Short
    Declare Function t4exprCB Lib "c465net.dll" (ByVal t4 As Integer) As Integer
    Declare Function t4filterCB Lib "c465net.dll" (ByVal t4 As Integer) As Integer
    Declare Function t4open Lib "c465net.dll" Alias "t4openCB" (ByVal dbPtr As Integer, ByVal IndexName As String) As Integer
    Declare Function t4seekN Lib "c465net.dll" (ByVal t4 As Integer, ByVal seekValue As String, ByVal inputKeyLen As Short, ByVal doDataPosition As Short) As Short
    Declare Function t4unique Lib "c465net.dll" (ByVal t4 As Integer) As Short
    Declare Function t4uniqueSet Lib "c465net.dll"  Alias "t4uniqueSetVB"(ByVal t4 As Integer, ByVal value As Short) As Short
#Else
...
#End If
    ...
    '-----------------------------------------------------------------------------------------------
#If USE_D4DLL Then
    Declare Function u4alloc Lib "c465net.dll"  Alias "u4allocDefault"(ByVal amt As Integer) As Integer
    Declare Function u4allocFree Lib "c465net.dll"  Alias "u4allocFreeDefault"(ByVal c4 As Integer, ByVal amt As Integer) As Integer
    Declare Sub u4free Lib "c465net.dll"  Alias "u4freeDefault"(ByVal memPtr As Integer)

    '16-Bit versions
    Declare Function u4ncpy Lib "c465net.dll" (ByVal MemPtr1 As String, ByVal memptr2 As Integer, ByVal memLength As Short) As Short
    Declare Function u4ncpy2 Lib "c465net.dll"  Alias "u4ncpy"(ByVal MemPtr1 As Integer, ByVal memptr2 As String, ByVal memLength As Short) As Short

    '32-Bit versions
    'Declare Function u4ncpy& Lib "c465net.dll" (ByVal MemPtr1$, ByVal memptr2&, ByVal memLength&)
    'Declare Function u4ncpy2& Lib "c465net.dll" Alias "u4ncpy" (ByVal MemPtr1&, ByVal memptr2$, ByVal memLength&)

    Declare Sub u4memCpy Lib "c465net.dll" (ByVal dest As String, ByVal source As Integer, ByVal numCopy As Integer)
    Declare Function u4switch Lib "c465net.dll" () As Integer
#Else
...
#End If
    ...
    '========================================================================================
#If USE_D4DLL Then
    Declare Function v4Cstring Lib "c465net.dll" (ByVal s As String) As Integer
    Declare Sub v4Cstringfree Lib "c465net.dll" (ByVal s As Integer)
#Else
...
#End If
    ...
    Public Const CB_TOP As Short = 1
    Public Const CB_PREV As Short = 2
    Public Const CB_SEARCH As Short = 3
    Public Const CB_NEXT As Short = 4
    Public Const CB_BOTTOM As Short = 5
    Public Const CB_APPEND As Short = 6
    Public Const CB_DEL As Short = 7
    Public Const CB_UNDO As Short = 8
    Public Const CB_FLUSH As Short = 9
    Public Const CB_GO As Short = 10
    ...
    Public Const MASTER4NODATA As Short = 1
    Public Const MASTER4NOTAG As Short = 2
    Public Const MASTER4BADEXPR As Short = 3
    Public Const CTRL4BADFIELD As Short = 4
    Public Const CTRL4NOTAG As Short = 5
    Public Const CTRL4BADEXPR As Short = 6
    ...
    Function d4create(ByVal cb As Integer, ByRef dbname As String, ByRef D() As FIELD4INFO, ByRef n() As TAG4INFO) As Integer
        ...
        'WriteTest("Lower: " & flb.ToString)
        'WriteTest("Upper: " & fub.ToString)
        ...
        'WriteTest((fub + 1).ToString)

        'Dim f((fub + 1)) As FIELD4INFOCB

        Dim f((fub)) As FIELD4INFOCB
        i = flb

        'WriteTest("D(" & i.ToString & ") UPPERBOUND: " & D.GetUpperBound(0).ToString)
    ...
    Function f4memoBinary(ByRef field As Integer) As Object
        ...
        Else
            ...
            ReDim Preserve buffer(fLen - 1)
        End If
        f4memoBinary = VB6.CopyArray(buffer)
    End Function
    ...
    Function f4name(ByRef fPtr As Integer) As String
        ...
        Dim FldName As VB6.FixedLengthString = New VB6.FixedLengthString(11) 'String to hold info
    ...
    Function t4filter(ByRef tPtr As Integer) As String
        ...
        Dim filter_Renamed As VB6.FixedLengthString = New VB6.FixedLengthString(255)
